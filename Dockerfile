...
RUN curl -L https://github.com/Xilinx/RapidWright/releases/download/v2021.1.1-beta/rapidwright-2021.1.1-standalone-lin64.jar > /rapidwright_kernel/rapidwright-2021.1.1-standalone-lin64.jar
RUN cd rapidwright_kernel && java -jar rapidwright-2021.1.1-standalone-lin64.jar --create_jupyter_kernel
