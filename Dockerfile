...
RUN curl -L https://github.com/Xilinx/RapidWright/releases/download/v2018.3.3-beta/rapidwright-2018.3.3-standalone-lin64.jar > /rapidwright_kernel/rapidwright-2018.3.3-standalone-lin64.jar
RUN cd rapidwright_kernel && java -jar rapidwright-2018.3.3-standalone-lin64.jar --create_jupyter_kernel
